...
summary(Fibulae$Length)

(DP_Type <- table(Fibulae$Length))
prop.table(DP_Type)*100
...
#bottle type 4 count
(Mic_f4 <- table(Michelsberg$f4))


pie(Mic_f4, main="Michelsberg type 4 bottles", xlab="Number of Type 4 Bottles per site", clockwise=TRUE)
#Pie chart isn't the best, will try a bargraph next

barplot(Mic_f4, main="Michelsberg type 4 bottles", xlab="Number of Type 4 Bottles per site", ylab="Number of sites")
...
View(Olorgesailie.sub)
#comparing knives (KN) to choppers (CH)
(table(Olorgesailie.sub$KN, Olorgesailie.sub$CH))

chisq.test(Olorgesailie.sub$KN, Olorgesailie.sub$CH, correct=FALSE)
# p-value of 0.06, no associations here

#comparing handaxes (HA) to pick-like handaxes (PHA)
(table(Olorgesailie.sub$HA, Olorgesailie.sub$PHA))

chisq.test(Olorgesailie.sub$HA, Olorgesailie.sub$PHA, correct=FALSE)
# p-value of 0.08, maybe there aren't many associations with this dataset.
...
(GRV <- table(graveyards$Burial.Ground.Name))
barplot(GRV, main="Graveyard Project Graves Per Site", xlab="Number of graves per site", ylab="Number of sites")

pie(GRV, main="Graveyard Project Graves Per Site", xlab="Number of graves", clockwise=TRUE)
